...
function family(familyName, base, { variants = 3, spread = 0.045, roughnessSpread = 0.07, name } = {}) {
  ...
  for (let i = 0; i < variants; i += 1) {
    ...
    const definition = createMaterialDefinition({
      ...
      metalness: clamp01(base.metalness + rng.range(-0.05, 0.05) * jitter),
...
family('canvasStain', { color: 0x5c5548, roughness: 0.89, metalness: 0.03 }, { variants: 4, spread: 0.022, name: 'Sweat-Darkened Canvas' });

import {compileCoherentSurface} from './coherent-surface.js';
import {surfaceFrame as frame} from './surface-frame.js';
...
export function compileSurfaceInstances(mesh,artifact,options={}){
 if(options.placement==='coherentSurface')return compileCoherentSurface(mesh,artifact,options);
 const {placement='surface',spacing=.65,candidateDensity=10}=options;

 ...
 * foot-contact locks. Motion Forge supplies locomotion and analytical IK.
 * HOOK is the existing combat identifier for the rear attack; this fidelity
 * pass presents that attack as a straight cross without changing its rules.
 */

import { Group, Object3D, Quaternion, Vector3, Matrix4, MeshStandardMaterial } from 'three';
import {
...
export function createOpponentBoxer({ library }) {
  ...
  const planted = createBoxingFeet();
